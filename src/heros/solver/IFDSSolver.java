 ...
 */
public class IFDSSolver<N,D,M,I extends InterproceduralCFG<N, M>,X> extends IDESolver<N,D,M,IFDSSolver.BinaryDomain,I,X> {
	 ...
	 * {@link #solve()}.
	 */
	public IFDSSolver(final IFDSTabulationProblem<N,D,M,I,X> ifdsProblem) {
