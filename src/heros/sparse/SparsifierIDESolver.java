...
// TODO: currently same as the IDESolver
 ...
 */
public class SparsifierIDESolver<N,D,M,V,I extends InterproceduralCFG<N, M>,X> {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(SparsifierIDESolver.class);
	 ...
	 */
	public SparsifierIDESolver(IDETabulationProblem<N,D,M,V,I,X> tabulationProblem) {
	 ...
	 */
	public SparsifierIDESolver(IDETabulationProblem<N,D,M,V,I,X> tabulationProblem, @SuppressWarnings("rawtypes") CacheBuilder flowFunctionCacheBuilder, @SuppressWarnings("rawtypes") CacheBuilder edgeFunctionCacheBuilder) {
			...
			for(N sP: startPointsOf) {
				...
				for(D d3: res) {
					...
					synchronized (incoming) {
						...
						endSumm = new LinkedHashSet<Cell<N,D,EdgeFunction<V>>>(endSummary(sP, d3));
					}
	 ...
	 *        (this value is not used within this implementation but may be useful for subclasses of {@link SparsifierIDESolver})
